...
This matrix identifies the evidence required to complete the current-state technical discovery for SAST adoption and to prepare implementation of an initial SAST scan that generates a report. It is intended to be maintained as a working document during stakeholder interviews and repository analysis.

## How to Use This Matrix

- capture evidence from system owners, platform teams, or repository inspection
- distinguish verified facts from assumptions
- identify blockers that would prevent initial scan execution or a later vendor-evaluation phase
...
## Discovery and Initial Scan Inputs
...
| Portfolio | Candidate repositories for the initial scan and selection rationale | Defines the initial execution scope | Engineering leadership and application owners | Stakeholder selection and repository review | Low | Open | Choose repositories that are representative and actively maintained |
...
| Build | Ability to execute the scan in existing CI runners or containers | Determines whether the initial scan can run without new infrastructure | Platform engineering | CI runner inventory and test runs | Low | Open | Include image, container, and network constraints |
...
| CI/CD | Ability to publish scan artifacts or report outputs | Determines how the initial report will be distributed | DevOps or platform team | Pipeline configuration and platform capabilities | Low | Open | Must be testable in the initial scan workflow |
...
| Reporting | Initial scan report audience and format | Defines the minimum contents and presentation of the report | Engineering leadership and AppSec | Stakeholder decision | Low | Open | Clarify summary versus detailed technical output |
...
| Governance | Initial scan support owner and escalation path | Ensures scan failures and report issues can be resolved quickly | Platform engineering and AppSec | Stakeholder interview | Low | Open | Define who responds to failed runs or unusable output |
...
| Initial scan | Initial scan success metrics and exit criteria | Defines the go or no-go threshold for scaling | Security leadership and engineering leadership | Stakeholder decision | Low | Open | Include scan time, signal quality, and report usability |
| Initial scan | Fallback posture if the scan fails or is too noisy | Prevents disruption to delivery during first execution | Platform engineering and AppSec | Stakeholder interview | Low | Open | Non-blocking is the default starting point |
...
- Which repositories and teams should participate in the initial scan?
- What makes the generated report useful enough for leadership review?
...
- Can the current runners or containers support scan execution without new infrastructure?
- Where will the initial scan report or artifacts be published?
...
- Is the team available to participate in triage and feedback after the initial scan?
- What report detail is needed to make follow-up work actionable?
...
- Who needs to approve the initial scan report before broader rollout decisions are made?
- What signal quality is acceptable for the initial report to be considered credible?

## Exit Criteria for Discovery and Initial Scan Readiness
...
4. repositories for the initial scan, scan owners, and report consumers are identified
5. report format, success metrics, and fallback posture are explicitly defined
6. leadership has enough evidence to decide whether to proceed to initial scan execution, vendor evaluation, or broader implementation planning