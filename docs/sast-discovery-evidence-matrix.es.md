...
Esta matriz identifica la evidencia requerida para completar el descubrimiento tecnico del estado actual para la adopcion de SAST. Su intencion es mantenerse como un documento de trabajo durante entrevistas con stakeholders y analisis de repositorios.
...
- identificar bloqueadores que impedirian una fase posterior de implementacion o evaluacion de proveedores
...
## Criterios de Salida del Descubrimiento
...
4. el liderazgo tiene suficiente evidencia para decidir si avanzar hacia una evaluacion de proveedores o una planificacion de implementacion